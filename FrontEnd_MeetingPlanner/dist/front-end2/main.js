...
var map = {
	"./admin/admin.module": [
		...
		"default~admin-admin-module~user-management-user-management-module~user-user-module",
		"admin-admin-module"
	],
...
/* harmony import */ var _services_error_interceptor_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/error-interceptor.service */ "./src/app/services/error-interceptor.service.ts");
            ...
            providers: [
                {
                    ...
                    useClass: _services_error_interceptor_service__WEBPACK_IMPORTED_MODULE_9__["ErrorInterceptorService"],
                    multi: true
                }
            ],
...
var ErrorInterceptorService = /** @class */ (function () {
    function ErrorInterceptorService(toastr, router) {
        this.toastr = toastr;
        this.router = router;
    }
...
module.exports = __webpack_require__(/*! C:\Users\DELL\new\Mean-stack-app1-meeting-planner-master\FrontEnd_MeetingPlanner\src\main.ts */"./src/main.ts");
